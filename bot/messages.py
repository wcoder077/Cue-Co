...
WHAT_NEXT = "Yangi prompt uchun 🔄 New prompt tugmasini bosing."
SESSION_EXPIRED = "Suhbat muddati tugagan. Iltimos, vazifani yana yuboring."
STALE_BUTTON = "Bu tugma eskirgan. Iltimos, /start yuboring."
